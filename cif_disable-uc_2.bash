...
CMD="$EXEC -r 1 -r2 3 -g 0.3 -fs $RESDIR/cif_examples/nature20771-s2.cif -o options,formula,time,vol,cavities -q"

EXPFILE=`basename $0 .bash`

if [[ "$2" == "update"  ]]; then
  echo UPDATING - CIF file 2 without unit cell
  ...
  # run test
  echo TESTING - CIF file 2 without unit cell:
